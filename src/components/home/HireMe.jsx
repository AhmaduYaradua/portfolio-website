    ...
    <div className="fixed left-4 bottom-0  flex items-center justify-center md:absolute overflow-hidden md:right-8 sm:right-0 md:left-auto md:top-[60px] md:bottom-auto">
      <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
        <svg
          ...
          className="w-full h-auto animate-[spin_6s_linear_infinite] fill-black dark:fill-white"
        >
          <metadata>
          ...
          >
            <path
              d="M1486 2875 c-31 -58 -56 -108 -56 -111 0 -2 11 -4 25 -4 17 0 29 8
...
-34 c7 -19 13 -40 13 -46z"
            />
            <path
              d="M1128 2859 c-10 -6 -18 -17 -18 -26 0 -12 -3 -14 -11 -6 -9 9 -49 7
-49 -2 0 -12 71 -155 77 -155 5 0 15 4 23 10 12 8 12 14 -3 45 -22 45 -22 81
0 94 13 7 15 14 7 29 -7 16 -13 19 -26 11z"
            />
            <path
              d="M1906 2764 c-44 -62 -47 -68 -31 -83 15 -15 18 -14 36 9 49 60 61 71
...
37 -16 7 -34 21 -41 30 -7 10 -17 18 -21 18 -4 0 -29 -30 -55 -66z"
            />
            <path
              d="M1301 2786 c-15 -18 -4 -46 19 -46 28 0 45 27 30 45 -16 19 -34 19
-49 1z"
            />
            <path
              d="M939 2755 c-14 -8 -32 -29 -39 -46 -26 -61 37 -132 102 -116 31 8 78
...
-65 -47 -8 5 -4 17 15 42 10 13 39 16 50 5z"
            />
            <path
              d="M786 2619 c-14 -11 -26 -29 -26 -40 0 -11 -4 -18 -9 -15 -4 3 -16 -3
...
m82 -41 c17 -17 15 -53 -3 -68 -38 -31 -96 27 -65 65 15 18 51 20 68 3z"
            />
            <path
              d="M2205 2593 c-4 -12 2 -23 19 -36 16 -11 26 -28 26 -43 0 -31 -13 -31
...
-42 37 0 16 32 17 48 1z"
            />
            <path
              d="M667 2449 c-21 -12 -47 -61 -47 -88 0 -11 12 -33 26 -50 54 -65 154
-22 154 65 0 65 -75 106 -133 73z m71 -45 c27 -19 28 -45 3 -68 -21 -19 -64
-9 -75 19 -9 26 14 60 44 64 3 1 16 -6 28 -15z"
            />
            <path
              d="M2273 2414 c-54 -27 -68 -108 -23 -136 10 -7 16 -17 13 -24 -2 -7 -1
...
42 22 16 30 16 55 3z"
            />
            <path
              d="M507 2279 c-3 -11 0 -22 6 -25 7 -2 58 -19 115 -38 80 -27 102 -32
104 -20 0 8 1 19 2 24 1 10 -183 80 -210 80 -6 0 -14 -9 -17 -21z"
            />
            <path
              d="M572 2173 c-17 -7 -42 -57 -42 -86 0 -34 34 -74 69 -82 65 -14 122
...
-13 -15 -3 -18 15 -20 51 -3 68 21 21 31 13 24 -19z"
            />
            <path
              d="M2450 2110 c-51 -39 -73 -50 -102 -50 -35 0 -38 -2 -38 -29 0 -28 1
...
-50 27 0 4 20 21 45 39 47 34 48 35 37 63 -6 14 -17 9 -72 -32z"
            />
            <path
              d="M520 1967 c0 -20 9 -27 62 -43 l62 -18 -61 -28 c-53 -25 -60 -31 -56
-52 l5 -24 82 39 c69 34 81 43 78 62 -2 12 -7 25 -10 28 -7 6 -148 59 -158 59
-2 0 -4 -11 -4 -23z"
            />
            <path
              d="M2325 1910 c-12 -13 -16 -30 -13 -55 2 -19 0 -35 -4 -35 -4 0 -8 -11
...
m55 -66 c0 -28 -3 -35 -17 -32 -31 6 -29 68 2 68 11 0 15 -10 15 -36z"
            />
            <path
              d="M573 1774 c-21 -21 -25 -32 -20 -66 3 -22 13 -48 22 -58 41 -45 121
...
54 -29 73 13 13 19 6 30 -33z"
            />
            <path
              d="M2281 1727 c-8 -19 -4 -24 23 -35 68 -27 81 -37 78 -64 -2 -19 3 -27
18 -31 25 -6 34 7 26 39 -4 16 -3 23 3 20 9 -6 28 32 19 38 -1 2 -38 15 -81
29 l-78 26 -8 -22z"
            />
            <path
              d="M643 1582 c-96 -53 -100 -57 -90 -79 l10 -23 32 20 c41 25 45 25 45
...
-19 70 18 22 67 19 80 -5z"
            />
            <path
              d="M2246 1609 c-18 -14 -26 -30 -26 -50 0 -17 -4 -28 -8 -25 -4 2 -13
...
-14 -16 -26 -3 -9 12 -10 21 -1 36 13 26 40 28 40 3z"
            />
            <path
              d="M2128 1428 c-16 -18 -39 -43 -51 -55 -11 -12 -19 -24 -16 -26 2 -1
...
-46 4 -63 -21 -16 -56 -9 -72 15 -12 18 -11 24 2 43 18 26 41 28 66 5z"
            />
            <path
              d="M835 1356 c-48 -48 -38 -111 23 -142 21 -10 21 -10 -5 -37 -22 -22
...
16 35 54 50 54 6 0 19 -9 30 -20z"
            />
            <path
              d="M1967 1281 c-14 -17 -27 -27 -31 -24 -3 3 -12 0 -20 -6 -13 -11 -9
...
57 -58 68 -90 68 -18 0 -36 -10 -52 -29z"
            />
            <path
              d="M1030 1253 c0 -17 16 -30 42 -37 26 -6 56 -42 44 -53 -3 -3 -31 9
...
-63 9 -63 34 0 18 7 17 49 -5z"
            />
            <path
              d="M1828 1208 c-16 -5 -28 -14 -28 -20 0 -6 -6 -8 -14 -5 -8 3 -21 0
...
16 -8 18 -15z"
            />
            <path
              d="M1187 1073 c-52 -94 -56 -112 -20 -113 6 0 29 32 51 72 l40 72 6 -34
...
-65 -3 0 -9 32 -13 71 -8 84 -10 89 -41 89 -19 0 -33 -17 -78 -97z"
            />
            <path
              d="M1592 1133 c-13 -26 -4 -43 24 -43 29 0 41 24 24 45 -17 20 -37 19
-48 -2z"
            />
          </g>
        </svg>
        <Link
          ...
          className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-black dark:border-white   text-white shadow-md border border-solid  border-black w-20 h-20 rounded-full hover:bg-white hover:text-black md:w-12 md:h-12 md:text-[10px] dark:bg-white dark:text-black hover:dark:bg-black hover:dark:text-white"
        >
          Hire me
        </Link>
      </div>
